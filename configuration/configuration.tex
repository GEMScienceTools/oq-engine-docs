...
\definecolor{lightblue}{rgb}{0.0,0.7,1.0}
\definecolor{darkviolet}{rgb}{0.6,0.0,0.8}
\definecolor{lightviolet}{rgb}{0.9,0.7,0.9}

\lstdefinelanguage{NRML}
{
    morestring=[s][\color{darkviolet}]{"}{"},
    ...
    morekeywords=[1]{nrml,exposureModel},
    keywordstyle=[1]{\color{darkblue}\bfseries},
    morekeywords=[2]{description},
