...
\titlecontents{chapter}
			  ...
			  {\color{ocre!80}\contentslabel[\Large\thecontentslabel]{1.25cm}\color{ocre}} % Chapter number
			  {\color{ocre}}
			  {\color{ocre!40}\large\sffamily\bfseries\;\titlerule*[.5pc]{.}\;\color{ocre!80}\thecontentspage} % Page number
			  []
