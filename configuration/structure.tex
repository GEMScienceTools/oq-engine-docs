...
{.1ex}
{\normalfont\footnotesize\sffamily\bfseries\em}}
...
\usepackage{hyperref}
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=true,
breaklinks=true,citecolor=darkblue,linkcolor=darkgray,urlcolor=ocre,bookmarks=true,
...
% to produce the glossary: makeglossaries oq-manual
