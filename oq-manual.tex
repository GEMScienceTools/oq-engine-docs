...
\includepdf[pages=-]{figures/OQ_user_manual.pdf}
...
\noindent
   ...
   \textit{Global Earthquake Model (GEM) Technical Report 2015-05.\\ 
   doi: 10.13117/GEM.OPENQUAKE.MAN.ENGINE.1.4/01, 127 pages.} \hfill \\
\noindent \hfill\\
\noindent
   {\bf{Disclaimer}} \hfill \\
