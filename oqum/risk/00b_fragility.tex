...
An example fragility model comprising one discrete fragility function and one
continuous fragility function is shown below:
...
The information in the metadata section is common to all of the functions in the
fragility model and needs to be included at the beginning of every fragility
...
necessary to define a fragility function for each building typology present in
the exposure model. The fragility functions can be defined using either a
discrete or a continuous format, and the fragility model file can include a
mix of both types of fragility functions.
