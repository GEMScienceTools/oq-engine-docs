...
\begin{itemize}
    ...
    \item \Verb+id+: mandatory; a unique string (UTF-8) used to identify the 
      \gls{fragilitymodel}
    ...
    \item \Verb+description+: mandatory; a brief string with further information about the
      \gls{fragilitymodel}, for example, which building typologies are covered
...
\begin{itemize}
    ...
    \item \Verb+format+: mandatory; for continuous \glspl{fragilityfunction}, this
    attribute should be set to ``\Verb+continuous+''

    \item \Verb+shape+: mandatory; for continuous \glspl{fragilityfunction} using the lognormal
    ...
    \item \Verb+imls+: mandatory; this element specifies various aspects related to the 
    ...
    \item \Verb+params+: mandatory; this field is used to define the parameters of the 
