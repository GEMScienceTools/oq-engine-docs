...
for running a classical probabilistic risk calculation is shown in Listing~\ref{lst:config_classical_risk_combined}.
...
\begin{listing}[htbp]
  ...
  \caption{Example combined configuration file for a classical probabilistic risk calculation}
...
exceedance curves and probabilistic loss maps for a portfolio of assets based
on the hazard curves and vulnerability models.
...
\begin{listing}[htbp]
  ...
  \caption{Example hazard configuration file for a classical probabilistic risk calculation}
...
\begin{listing}[htbp]
  ...
  \caption{Example risk configuration file for a classical probabilistic risk calculation}
