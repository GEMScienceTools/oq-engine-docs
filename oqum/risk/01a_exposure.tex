...
\begin{itemize}
  ...
  \item \Verb+description+: mandatory; a brief string (UTF-8) with further
...
assessment. This attribute can be set to any valid UTF-8 string.
...
\begin{itemize}
  ...
  \item \Verb+id+: mandatory; a unique string (UTF-8) used to identify the 
    ...
    \gls{asset} with its associated results.
