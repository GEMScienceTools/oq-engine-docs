...
\begin{listing}[htbp]
  ...
  \caption{Example combined configuration file for running a scenario damage calculation}
...
\begin{listing}[htbp]
  ...
  \caption{Example hazard configuration file for a scenario damage calculation}
...
\begin{listing}[htbp]
  ...
  \caption{Example risk configuration file for a scenario damage calculation}
...
the option \Verb+,hazard-calculations+ (or \Verb+--lhc+) can be used to
...
The option \Verb+,outputs+ (or \Verb+--lo+) can be used to display a
...
OpenQuake-engine or some other software. The ground motion fields can be
...
\begin{listing}[htbp]
  ...
  \caption{Example configuration file for a scenario damage calculation using a precomputed set of ground motion fields}
...
file, as demonstrated in \ref{subsec:gmlt}. As of OpenQuake-engine v1.8, the
...
\begin{listing}[htbp]
  ...
  \caption{Example ground motion logic tree for a scenario calculation}
...
\begin{listing}[htbp]
  ...
  \caption{Example configuration file for a scenario damage calculation using a logic-tree file}
...
\begin{listing}[htbp]
  ...
  \caption{Example configuration file for a scenario damage calculation followed by a consequences analysis}
