...
For further information about consulting the \verb+id+ of hazard results or
calculations, users are referred to Chapter~\ref{chap:riskinputs}. To obtain a
list of all the risk calculations, the following command can be employed.
...
Then, in order to export the risk calculation outputs in the appropriate xml
